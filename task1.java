        ...
        for (int i = 1; i <= rounds; i++) {
            ...
            switch (limits) {
                ...
                case 2: {
                    ...
                    System.out.println("The limit is just 6.\nIf you have guessed the number in 6 or less attempts you have won the game.\n Else you will lose the game.\n");
                    int randomNumber = 1 + rand.nextInt(100);
                    System.out.println("Random Number has been generated...");

                    int count = 1;
                    whileloop: while (count <= 6) {
                        System.out.println("\nNo of guesses remaining : " + (7 - count) + " ...\n");
                        System.out.print("Enter you guess number " + count + ": ");
                        int guess = obj.nextInt();
                        if (guess > randomNumber) {
                            System.out.println("The number " + guess + " is HIGHER than Generated Number. You have to Guess again...");
                    ...
                    if (count > 6) {
                        System.out.println("OOPS!!! You were not able to guess the number in 6 attempts.\nThe Generated Number was " + randomNumber + "\nBETTER LUCK NEXT TIME\n");
                    }
                    break;
                }
                default: {
